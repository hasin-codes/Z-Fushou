...
/** Format ISO timestamp to "Jun 1, 14:30" in Beijing time. */
...
export function MentionedTable({ mentions }: { mentions: MentionedMessage[] }) {
          ...
          <tbody>
            {sorted.map((m) => (
              ...
              >
                ...
                <td className="px-2 py-3" style={{ width: '48%' }}>
                ...
                <td className="px-2 py-3 text-[12px] font-medium text-sage-600 dark:text-[#929292] truncate" style={{ width: '18%' }}>
                  {formatDateAndTime(m.timestamp)}
                </td>
